...
angular.module('timeAgo').config(["timeAgoSettings", function(timeAgoSettings) {
...
angular.module('timeAgo').factory('nowTime', ["$interval", "timeAgo", "timeAgoSettings", function($interval, timeAgo, timeAgoSettings) {
    var nowTime;
...
angular.module('timeAgo').constant('timeAgoSettings', {
    refreshMillis: 1000,
    allowFuture: false,
    overrideLang: null,
...
angular.module('timeAgo').directive('timeAgo', ["timeAgo", "nowTime", function(timeAgo, nowTime) {
    return {
        scope: {
            fromTime: '@',
            format: '@'
...
angular.module('timeAgo').factory('timeAgo', ["$filter", "timeAgoSettings", function($filter, timeAgoSettings) {
    var service = {};
...
angular.module('timeAgo').filter('timeAgo', ["nowTime", "timeAgo", function(nowTime, timeAgo) {
